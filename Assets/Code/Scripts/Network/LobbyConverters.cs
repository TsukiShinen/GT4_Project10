...
namespace Network
{
	public static class LobbyConverters
	{
		...
		private const string k_KeyLastEdit = nameof(LocalLobby.LastUpdated);
		...
		public static void RemoteToLocal(Lobby remoteLobby, LocalLobby localLobby)
		{
			...
			localLobby.LocalLobbyState.Value = remoteLobby.Data != null &&
			                                   remoteLobby.Data.TryGetValue(k_KeyLobbyState, out var value1)
